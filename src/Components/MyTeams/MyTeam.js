...
import suman from '../Images/suraj.jpg';
...
const items = [
    ...
    <div className="item m-4 " data-value="2">
        ...
        <h4><span className="text-xl text-blue-500">Suresh Shrestha </span><br /> Full-Stack Developer </h4>
    </div>,
    <div className="item m-4" data-value="3">
        <img src={suman} alt="NoImage" className="w-full h-64 object-cover" />
        <h4><span className="text-xl text-blue-500">Subash Bhandari </span><br /> Full-Stack Developer </h4>
    </div>,
    <div className="item m-4 " data-value="4">
        <img src={sachin} alt="NoImage" className="w-full h-64 object-cover" />
        <h4><span className="text-xl text-blue-500">Hari Krishna Khuju </span><br /> Marketing </h4>
    </div>,
    <div className="item m-4 " data-value="5">
        <img src={sumina} alt="NoImage" className="w-full h-64 object-cover" />
        <h4><span className="text-xl text-blue-500">Govinda Bista </span><br /> Finance and Revenue </h4>
    </div>,
];
